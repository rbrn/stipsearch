...
import com.db.pwcc.tre.elastic.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.db.pwcc.tre.elastic.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "stipsearchEmployee";
