...
@RestController
@RequestMapping("/api/stipsearch-kafka")
public class StipsearchKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StipsearchKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StipsearchKafkaResource(KafkaProperties kafkaProperties) {
